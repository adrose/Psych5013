...
This confidence interval suggests that if this sampling procedure was repeated, we would expect the standard deviation of the slope estimate to be about `r round(qt(p = .975, df=4) * 0.27247, 4)`.
