...
## a. 
$R^2_{Y.X2X3}=\frac{r^2_{YX2}+r^2_{YX3}-2r_{YX1}r_{YX3}r_{X2X3}}{1-r^2_{X2X3}}$
...
Model SS: `r (4.58 * ((1.03178^2 * 98) / 97)) * 2`

Model Mean Square: `r 4.58 * ((1.03178^2 * 98) / 97)`

Error SS: `r 1.03178^2 * 98`

Error Mean Square: `r (1.03178^2 * 98) / 97`

Corrected Total DF: 99

Corrected Total SS: `r (1.03178^2 * 98) + ((4.58 * ((1.03178^2 * 98) / 97)) * 2)` 
...
X1 Semi-partial Corr Type I: `r spcor.x1.x2`
